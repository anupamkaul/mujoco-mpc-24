...
// allocate memory
void dummyBackwardPass::Allocate(int dim_dstate, int dim_action, int T) {
...
void dummyBackwardPass::Reset(int dim_dstate, int dim_action, int T) {
  mju_zero(dV, 2);
...
int dummyBackwardPass::RiccatiStep(
...
void dummyBackwardPass::ScaleRegularization(double factor, double reg_min,
                                           double reg_max) {
  // scale rate
  if (factor > 1)
...
void dummyBackwardPass::UpdateRegularization(double reg_min, double reg_max,
                                            double z, double s) {
